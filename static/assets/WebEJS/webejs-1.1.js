...
WebEJS_GEN.generate_view = {
  ...
  getTreeCode : function(view_tree,description_pages,variables_list,fullmodel, forPackage) {
    ...
    if (view_tree.length)
      ...
      code.push(WebEJS_GEN.generate_view.__EMPTY_VIEW.replaceAll('{{WEBEJS_ASSETS_FOLDER}}',sMainStaticURL+'assets/'));
...
const sDescriptionIFrameOnLoad = function(hash) {
		  ...
		  var css = '<link href="'+sMainStaticURL+'assets/_ejs_library/css/ejss.css" rel="stylesheet" type="text/css" />';
...
WebEJS_GUI.previewArea = function() {
	...
	self.clearPreview = function(title) {
		$('#sPreviewFrame').attr('src', sMainStaticURL+'assets/WebEJS/EmptyView/empty_view.html');
